  ...
  return (
    <div className="container mx-auto px-10 py-10 bg-background text-text">
      ...
      <section className="bg-secondary py-10 mb-10 px-10 rounded-lg text-center">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-primary mb-10">
          Introduction
        </h2>
        <hr className="border-t-1 border-primary opacity-20 w-full mb-10" />

        <p className="text-base sm:text-lg md:text-xl text-text mb-4 leading-relaxed italic">
      ...
      <section className="bg-background py-12 px-10 rounded-lg">
        <h2 className="text-3xl sm:text-4xl font-extrabold text-primary mb-10 text-center">
          Experience
        </h2>
        <hr className="border-t-1 border-primary opacity-20 w-full mb-10" />
      ...
      <section className="bg-background py-10 mb-10 px-10 rounded-lg">
        ...
        <hr className="border-t-1 border-primary opacity-20 w-full mb-10" />
        <ul className="list-disc list-inside text-base sm:text-lg md:text-xl text-text space-y-2 mx-auto max-w-lg">
          <li>Age: {age}</li>
          <li>Location: Matara, Sri Lanka</li>
          <li className="whitespace-nowrap">Email: chiranjonline@gmail.com</li>
      ...
      <section className="bg-background-alt py-10 mb-10 px-10 rounded-lg text-center">
        ...
        <hr className="border-t-1 border-primary opacity-20 w-full mb-10" />
        <p className="text-base sm:text-lg md:text-xl text-text mb-4 leading-relaxed">
